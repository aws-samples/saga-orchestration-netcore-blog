...
namespace CdkSagaOrchestration
{
    public class CdkSagaOrchestrationStack : Stack
    {
        public CdkSagaOrchestrationStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
        {
            ...
            iamLambdaRole.AddManagedPolicy(ManagedPolicy.FromManagedPolicyArn(this, "AWSLambdaVPCAccessExecutionRole",
            ...
            iamStepFunctionRole.AddManagedPolicy(ManagedPolicy.FromManagedPolicyArn(this, "AWSLambdaRole",
            ...
            var invokeOrchestratorLambda = new Function(this, "InvokeOrchestratorLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/InvokeOrchestratorLambda/src/InvokeOrchestratorLambda/",
            ...
            var invokeOrchestratorIntegration = new LambdaIntegration(invokeOrchestratorLambda,
                new LambdaIntegrationOptions
                {
                    ...
                    {
                        ["application/json"] =
                            "#set($inputRoot = $input.path(\'$\')) { \"ItemId\" : \"$inputRoot.ItemId\",  \"CustomerId\" : \"$inputRoot.CustomerId\", \"MessageId\" : \"$inputRoot.MessageId\",\"FailAtStage\" : \"$inputRoot.FailAtStage\"}"
                    },
            ...
            var placeOrderLambda = new Function(this, "PlaceOrderLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/PlaceOrderLambda/src/PlaceOrderLambda/", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
            ...
            var updateInventoryLambda = new Function(this, "UpdateInventoryLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/UpdateInventoryLambda/src/UpdateInventoryLambda/", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
            ...
            var makePaymentLambda = new Function(this, "MakePaymentLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/MakePaymentLambda/src/MakePaymentLambda/", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
            ...
            var revertPaymentLambda = new Function(this, "RevertPaymentLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/RevertPaymentLambda/src/RevertPaymentLambda", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
            ...
            var revertInventoryLambda = new Function(this, "RevertInventoryLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/RevertInventoryLambda/src/RevertInventoryLambda", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
            ...
            var removeOrderLambda = new Function(this, "RemoveOrderLambda", new FunctionProps
            {
                ...
                Role = iamLambdaRole,
                Code = Code.FromAsset("../saga-orchestration/RemoveOrderLambda/src/RemoveOrderLambda/", new Amazon.CDK.AWS.S3.Assets.AssetOptions
                {
                    Bundling = bundlingOptions
                }),
                Timeout = Duration.Seconds(300)
